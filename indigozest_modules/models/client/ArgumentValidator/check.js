  ...
  while (argsNum--) {
    ...
    while (criteriaCallbacksNum--) {
      ...
      if (typeof criteriaFunction !== 'function') {
        throw Error('There was a problem validating criteria against a function\'s arguments. Ensure valid criteria callback function(s) specified. ' +
						`Argument value: ${argsNum + 1}. Criteria callbacks: ${criteriaCallbacks}`)
      }
      if (criteriaFunction(args[argsNum])) {
        throw Error('Invalid argument(s) passed. Violation of criteria function ' +
