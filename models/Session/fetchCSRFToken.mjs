import { fetchCSRFTokenHTTPCall } from "./helper/fetchCSRFTokenHTTPCall.mjs";
export async function fetchCSRFToken() {
    ...
    if(!("csrfToken" in response.data)) throw Error(`Unable to read CSRF token from HTTP call: ${response} ${response.data}`);
